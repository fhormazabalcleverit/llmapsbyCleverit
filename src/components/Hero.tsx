    ...
    <section className="bg-backblack min-h-screen flex items-center relative overflow-hidden -top-16">
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          {/* Main Heading */}
          <h1 className="text-5xl md:text-7xl lg:text-7xl font-bold text-white mb-8 leading-tight animate-slide-up max-w-5xl mx-auto">
            Carga, memoriza y{' '}
          ...
          {/* Description */}
          <p className="text-xl md:text-xl text-gray-300 mb-12 leading-relaxed max-w-3xl mx-auto animate-slide-up-delay">
