...
const ChatInterface = () => {
  ...
  const phrases = [
    "Encuentra el mes con mayores ventas del 2025",
  ...
  return (
    <div className="max-w-4xl mx-auto mt-16 mb-8">
      ...
      <div className="bg-gradient-to-r from-pink-500/20 via-purple-600 to-pink-500 p-2 rounded-2xl backdrop-blur-sm">
