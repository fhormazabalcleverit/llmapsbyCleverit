          ...
          {steps.map((step, index) => (
           ...
           {/* <div className="mb-0">
              ...
              <div className="flex-2 flex items-end">
                <p className="text-gray-400 leading-relaxed text-bold text-md opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-500 delay-200">
                  {step.description}
                </p>
              </div>
            </div>
