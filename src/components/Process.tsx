      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div ref={cardsRef} className={`flex flex-col lg:flex-row gap-4 items-stretch fade-in-up-delay  ${cardsVisible ? 'animate' : ''}`}>
          {steps.map((step, index) => (
            <div
              key={index}
              className="group relative bg-black/10 backdrop-blur-md border-0 border-backblack hover:border-pink-500/50 rounded-2xl p-6 lg:p-6 transition-all duration-500 ease-in-out cursor-pointer flex-2 lg:hover:flex-[2] min-h-[200px] lg:min-h-[200px] flex flex-col hover:bg-backblack/80 bg-gradient-to-r from-blue-500/10 via-sky-600/3 to-purple-500/10">
           {/* <div className="mb-0">
